...
async def main_async(args: argparse.Namespace) -> dict[str, Any]:
    ...
    res = {}
    res["duration"] = benchmark_result["duration"]
    res["completed"] = benchmark_result["completed"]
    res["total_input_tokens"] = benchmark_result["total_input_tokens"]
    res["total_output_tokens"] = benchmark_result["total_output_tokens"]
    res["request_throughput"] = benchmark_result["request_throughput"]
    res["output_throughput"] = benchmark_result["output_throughput"]
    res["total_token_throughput"] = benchmark_result["total_token_throughput"]
    res["mean_ttft_ms"] = benchmark_result["mean_ttft_ms"]
    res["median_ttft_ms"] = benchmark_result["median_ttft_ms"]
    res["p99_ttft_ms"] = benchmark_result["p99_ttft_ms"]
    res["mean_tpot_ms"] = benchmark_result["mean_tpot_ms"]
    res["median_tpot_ms"] = benchmark_result["median_tpot_ms"]
    res["p99_tpot_ms"] = benchmark_result["p99_tpot_ms"]
    res["mean_itl_ms"] = benchmark_result["mean_itl_ms"]
    res["median_itl_ms"] = benchmark_result["median_itl_ms"]
    res["p99_itl_ms"] = benchmark_result["p99_itl_ms"]
