...
class EngineArgs:
    ...
    number_of_ranks: Optional[int] = ModelConfig.number_of_ranks
    npus_per_rank: Optional[int] = ModelConfig.npus_per_rank
    device_name_config: Optional[str] = ModelConfig.device_name_config
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        model_group.add_argument("--device_name_config",
                                 **model_kwargs["device_name_config"])
        model_group.add_argument("--npus_per_rank",
                                 **model_kwargs["npus_per_rank"])
        model_group.add_argument("--number_of_ranks",
                                 **model_kwargs["number_of_ranks"])
    ...
    def create_model_config(self) -> ModelConfig:
        ...
        return ModelConfig(
            ...
            npus_per_rank=self.npus_per_rank,
            number_of_ranks=self.number_of_ranks,
            device_name_config=self.device_name_config,
        )
