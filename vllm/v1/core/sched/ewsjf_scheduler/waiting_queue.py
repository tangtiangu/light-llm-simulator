...
class WaitingQueue:
    ...
    def initialize_queues_by_length(self, min_input, max_input, step_size: int = 200):
        for start in range(min_input, max_input, step_size):
            end = min(start + step_size - 1, max_input)
            self._create_queue((start, end), False)
