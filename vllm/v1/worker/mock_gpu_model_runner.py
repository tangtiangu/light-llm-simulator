...
class GPUModelRunner_(LoRAModelRunnerMixin, KVConnectorModelRunnerMixin):
    ...
    def __init__(
        ...
        self.logits = torch.randn(self.max_num_tokens, model_config.get_vocab_size(),
    ...
    def execute_model(
        ...
        # Padding for DP
        num_pad, num_tokens_across_dp =  0, None #self.get_dp_padding(num_input_tokens)
        ...
        if not get_pp_group().is_last_rank:
            ...
            logits = self.logits[:sample_hidden_states.shape[0], :]
    ...
    def initialize_kv_cache(self, kv_cache_config: KVCacheConfig) -> None:
        ...
        # kv_caches = self.initialize_kv_cache_tensors(kv_cache_config) sefi
